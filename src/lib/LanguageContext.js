...
const translations = {
  en: {
    ...
    officialUsdRate: "USD CBU rate",
    bctUsdRate: "USD BCT rate",
    ...
    deleteModelDescription:
      "This action cannot be undone. It will permanently delete the selected {model} and remove it from our servers.",
    ...
    companyStatSingular: "Company stat",
    adminSingular: "Administrator",
    currencySingular: "Currency",
    bannerSingular: "Banner",
    backgroundSingular: "Background",
    featuredReviewSingular: "Color",
    ...
    records: "records",
    information: "information",
    manageModelDescription: "Manage {model} information",
    manageRecordsDescription: "Manage all {model} records",
    loadingModel: "Loading {model}...",
    noDataForModel: "No data available for {model}.",
  ...
  ru: {
    ...
    officialUsdRate: "Курс USD CBU",
    bctUsdRate: "Курс USD BCT",
    ...
    updating: "Обновление",
    creating: "Создание",
    createModelTitle: "Создать: {model}",
    editModelTitle: "Редактировать: {model}",
    deleteModelDescription:
      "Это действие нельзя отменить. Запись «{model}» будет навсегда удалена с серверов.",
    ...
    contactSingular: "Контакт",
    newsSingular: "Новость",
    blogSingular: "Блог",
    partnerSingular: "Клиент",
    projectSingular: "Проект",
    vendorSingular: "Вендор",
    reviewSingular: "Отзыв",
    experimentSingular: "Эксперимент",
    companyStatSingular: "Статистика компании",
    adminSingular: "Администратор",
    currencySingular: "Валюта",
    bannerSingular: "Баннер",
    backgroundSingular: "Фон",
    featuredReviewSingular: "Цвет",
    ...
    clientsInfo: "Информация о клиентах",
    partnersInfo: "Информация о партнёрах",
    ...
    experienceInfo: "Информация об опыте",
    ...
    manageModelDescription: "Управление разделом «{model}»",
    manageRecordsDescription: "Управление записями раздела «{model}»",
    loadingModel: "Загрузка: {model}...",
    noDataForModel: "Для раздела «{model}» пока нет данных.",
    createFirstRecord: "Создайте первую запись.",
    searchModelPlaceholder: "Поиск: {model}...",
  ...
  uz: {
    ...
    officialUsdRate: "USD CBU kursi",
    bctUsdRate: "USD BCT kursi",
    ...
    createModelTitle: "Yaratish: {model}",
    editModelTitle: "Tahrirlash: {model}",
    deleteModelDescription:
      "Bu amalni bekor qilib bo‘lmaydi. “{model}” yozuvi serverlardan butunlay o‘chiriladi.",
    ...
    productSingular: "Mahsulot",
    contactSingular: "Aloqa",
    newsSingular: "Yangilik",
    blogSingular: "Blog",
    partnerSingular: "Hamkor",
    projectSingular: "Loyiha",
    vendorSingular: "Vendor",
    reviewSingular: "Sharh",
    experimentSingular: "Eksperiment",
    companyStatSingular: "Kompaniya statistikasi",
    adminSingular: "Administrator",
    currencySingular: "Valyuta",
    bannerSingular: "Banner",
    backgroundSingular: "Fon",
    featuredReviewSingular: "Rang",
    ...
    content: "Kontent",
    color: "Rang",
    colorKey: "Rang kaliti",
    selected: "Tanlangan",
    creationInfo: "Yaratilish haqida",
    clientsInfo: "Mijozlar haqida",
    partnersInfo: "Hamkorlar haqida",
    technologies: "Texnologiyalar",
    scanners: "Skanerlar",
    scales: "Tarozilar",
    printers: "Printerlar",
    cashiers: "Kassalar",
    footerInfo: "Sayt pastki qismi haqida",
    experienceInfo: "Tajriba haqida",
    ...
    manageModelDescription: "“{model}” bo‘limini boshqarish",
    manageRecordsDescription: "“{model}” yozuvlarini boshqarish",
    loadingModel: "{model} yuklanmoqda...",
    noDataForModel: "“{model}” uchun ma’lumot mavjud emas.",
    createFirstRecord: "Birinchi yozuvni yarating.",
    searchModelPlaceholder: "Qidirish: {model}...",
    loadingEditor: "Muharrir yuklanmoqda...",
    normalText: "Oddiy matn",
    headingLevel: "Sarlavha {level}",
    bold: "Qalin",
    italic: "Kursiv",
    ...
    insertLink: "Havola qo‘shish",
    enterLinkUrl: "URL manzilini kiriting:",
    noContentAvailable: "Kontent mavjud emas",

    // Validation
    required: "majburiy",
    allLanguagesRequired: "Bu maydonni ingliz, rus va o‘zbek tillarida to‘ldiring",
    invalidColor: "To‘g‘ri HEX rang kiriting (#RRGGBB)",
